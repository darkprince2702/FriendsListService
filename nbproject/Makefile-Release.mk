...
${OBJECTDIR}/FriendsListService.o: FriendsListService.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FriendsListService.o FriendsListService.cpp

${OBJECTDIR}/FriendsListServiceHandler.o: FriendsListServiceHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FriendsListServiceHandler.o FriendsListServiceHandler.cpp

${OBJECTDIR}/FriendsListServiceServer.o: FriendsListServiceServer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FriendsListServiceServer.o FriendsListServiceServer.cpp
...
${OBJECTDIR}/HashMapModel.o: HashMapModel.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HashMapModel.o HashMapModel.cpp

${OBJECTDIR}/Memcached.o: Memcached.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Memcached.o Memcached.cpp

${OBJECTDIR}/MemcachedModel.o: MemcachedModel.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MemcachedModel.o MemcachedModel.cpp

${OBJECTDIR}/friendslistservice_constants.o: friendslistservice_constants.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/friendslistservice_constants.o friendslistservice_constants.cpp

${OBJECTDIR}/friendslistservice_types.o: friendslistservice_types.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/friendslistservice_types.o friendslistservice_types.cpp
